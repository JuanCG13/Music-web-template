const PHONE = '595976534549'
const MESSAGE =
  'Hola María Paz, me gustaría conversar sobre tu música.'

export const whatsappLink = `https://wa.me/${PHONE}?text=${encodeURIComponent(
  MESSAGE,
)}`
...
export default function WhatsAppButton() {
  return (
    ...
    >
      <span className="hidden sm:block bg-surface-container-high border border-outline-variant/50 text-parchment text-sm font-headline px-4 py-2 rounded-full shadow-lg opacity-0 translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all pointer-events-none">
